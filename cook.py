...
# with st.expander('6\) Results  \- Energy Cost'):
	...
	'Baseline':[bs_uc,bs_opc,bs_ovc,bs_etc],
	'e-Cooking':[el_uc,el_opc,el_ovc,el_etc],
	'Delta':[(el_uc - bs_uc),(el_opc - bs_opc),(el_ovc - bs_ovc),(el_etc - bs_etc)]
	}
...
with st.expander('6\) Results  \- Health Impacts'):
	...
	'Baseline':[bs_dihap,bs_ahap,bs_haz,bs_mort],
...
with st.expander('7\) Results  \- Financing'):
	...
	'Baseline':[bs_aninc,'-',bs_uce,bs_tce,'-','-'],
	'e-Cooking':['NA',el_pbp,el_uce,el_tce,el_ucc,el_tcrp],
	'Delta':['-','-',(el_uce - bs_uce),(el_tce - bs_tce),'-','-']
	}
