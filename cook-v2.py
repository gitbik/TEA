...
with st.expander('4\) Results  \- Cookstove Characteristics'):
	...
	df_cst_var_col = df_cst_var.style.apply(highlight_rows, axis=1).set_precision(2)
...
### START - Sample colour tables
	...
	df_tcost_test = df_tcost_test.style.apply(highlight_greater, axis=1).set_precision(2)	
